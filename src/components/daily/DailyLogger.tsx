        ...
        <CardContent className="space-y-6">
          {sessions.map((session, index) => (
            <div key={session.id} className="p-6 bg-gray-50 rounded-2xl border border-gray-200 flex flex-col md:flex-row gap-6 items-start md:items-center">
              ...
              <Button variant="ghost" size="icon" className="text-red-500 hover:text-red-700 hover:bg-red-50 self-start md:self-center" onClick={() => removeSession(session.id)} aria-label="Remove session">
